  ...
  return (
    <th
      ...
      className={cn(
        ...
        headerCellSpacing,
        props.tableLayout?.headerBorder && 'border-e',
  ...
  return (
    <div
      {...{
        ...
        className:
          'absolute top-0 h-full w-4 cursor-col-resize user-select-none touch-none -end-2 z-10 flex justify-center before:absolute before:w-px before:inset-y-0 before:-translate-x-px',
      }}
    />
  );
}
